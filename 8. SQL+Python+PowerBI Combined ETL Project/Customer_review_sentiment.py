...
def fetch_data_from_sql():
    ...
    conn_str = (
        ...
        "Server=DESKTOP-8BL3MIG\SQLEXPRESS01;"  # Specify your SQL Server instance
...
# Build the full path to save the CSV
output_path = os.path.join(script_dir, "customer_reviews_sentiment.csv")
